...
- `cefari-desktop` is the shipped desktop app binary. It owns the Tao window, CEF initialization, single-instance locking, runtime logging setup, native menus, tray integration, update flow wiring, and daemon service wiring.
