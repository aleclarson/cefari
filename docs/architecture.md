...
- `packages/cefari-cli`: developer tool distributed separately from Cefari apps. It owns scaffolding, dev orchestration, frontend and daemon builds, desktop builds, package assembly, signing, notarization, update artifact generation, diagnostics, and cleanup.
...
- `packages/cefari-cli` should not pull desktop windowing or browser runtime responsibilities into developer tooling.
